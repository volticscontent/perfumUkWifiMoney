...
console.log(📊 Produtos unificados: );
console.log(📊 Variants completos: );
...
unifiedProducts.products.forEach(product => {
  if (product.handle && product.handle.startsWith('3-piece-premium-fragrance-collection-set-')) {
    ...
    if (matchingVariant) {
      ...
      console.log(❌ Não encontrado variant para: );
    }
  }
});

console.log(\n📈 Mapeamento criado com  produtos);
...
console.log(💾 Novo mapeamento salvo: );
